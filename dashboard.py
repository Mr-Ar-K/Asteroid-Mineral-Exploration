...
data_source = st.sidebar.selectbox(
    "Select Data Source",
    ["Demo Data", "NASA Live Data", "Upload CSV"]
)
...
if data_source == "Demo Data":
    ...
    st.sidebar.text_input("NASA API Key", key="nasa_api_key", type="default", value="ieNKM2I1HjxFtKde7SNHEUmqlI5zj3A6MriHgbZC")
...
if st.session_state.asteroid_data is None:
    ...
    with col2:
        ...
        if {'semi_major_axis', 'eccentricity'}.issubset(df.columns):
            fig_orbit = px.scatter(
                ...
                size='diameter' if 'diameter' in df.columns else None, hover_name='name' if 'name' in df.columns else None,
    ...
    if st.session_state.predictions is not None:
        ...
        resource_options = df_pred['Potential_Resources'].unique()
        ...
        filtered_df = filtered_df[filtered_df['Potential_Resources'].isin(selected_resources)]
        if search_name:
    ...
    # Interactive scatter plot
        ...
        fig_scatter = px.scatter(
            ...
            color_discrete_map={
                'High Value': '#28a745',
                'Moderate Value': '#ffc107',
                'Low Value': '#fd7e14',
                'Scientific Interest': '#6f42c1',
                'Not Viable': '#dc3545'
            }
        )
